...
export default function About(){
            ...
            <div className = 'about_principal_funciones' style={{flexDirection: 'row', justifyContent: 'center'}}>
              <div class="parent" style={{margin: '10px'}}>
                <div class="card">
                    ...
                    <div class="glass"></div>
                    <div class="content">
                        <span class="title">Desarrollo y Ejecución</span>
                        <span class="text">Pagina web dinamica con funcionalidades especificas</span>
                    </div>
                    <div class="bottom">
  ...
  <path d="M16 16v-3a2 2 0 0 0 -4 0" />
                        ...
                        <div class="view-more">
                            <button class="view-more-button">Juan Mass Guardo</button>
                            <svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"></path></svg>
                        </div>
                    </div>
                </div>
